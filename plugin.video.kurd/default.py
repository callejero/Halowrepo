...
def main():
    ...
    add_video_item('rtmp://live1.karwan.tv/karwan.tv/<playpath>kurdistan-tv.stream'			,{ 'title': 'Kurdistan TV'}, icons + 'kurdistan-tv.png')
    add_video_item('rtmp://live1.karwan.tv/karwan.tv//zagros-tv.stream'				,{ 'title': 'Zagros TV'}, icons + 'zagros-tv.png')
    add_video_item('rtmp://live2.karwan.tv/nalia-tv//nalia-tv.stream'					,{ 'title': 'Nalia TV HD'}, icons + 'nalia-tv.png')
    add_video_item('rtmp://live2.karwan.tv/nalia-2-tv//nalia-2-tv.stream'				,{ 'title': 'Nalia 2 TV HD'}, icons + 'nalia-2-tv.png')
    add_video_item('rtmp://live2.karwan.tv/rudaw-tv//rudaw-tv.stream'					,{ 'title': 'Rudaw TV'}, icons + 'rudaw.png')
    add_video_item('rtmp://live2.karwan.tv/knn-tv//knn-tv.stream'						,{ 'title': 'KNN TV'}, icons + 'knn-tv.png')
    #     add_video_item('rtmp://live2.karwan.tv/geli-kurdistan-tv/<playpath>geli-kurdistan-tv.stream',{ 'title': 'Geli Kurdistan'}, icons + 'geli-kurdistan-tv.png')
    ...
    add_video_item('rtmp://live1.karwan.tv/karwan.tv/korek-tv.stream'					,{ 'title': 'Korek TV'}, icons + 'korek-tv.png')
    add_video_item('rtmp://live2.karwan.tv/kurdmax-tv/<playpath>kurdmax-tv.stream'				,{ 'title': 'KurdMAX TV'}, icons + 'kurdmax-tv.png')
    add_video_item('rtmp://live1.karwan.tv/karwan.tv/kanal4.stream'						,{ 'title': 'Kanal 4'}, icons + 'kanal4.png')
    ...
    add_video_item('rtmp://live2.karwan.tv/gem-kurd-tv//gem-kurd-tv.stream'			,{ 'title': 'GEM Kurd TV'}, icons + 'gem-kurd-tv.png')
    add_video_item('rtmp://live1.karwan.tv/karwan.tv//4sem-tv.stream'					,{ 'title': '4 Sem TV'}, icons + '4sem-tv.png')
    add_video_item('rtmp://live.karwan.tv:1935/gk-silemani-tv/<playpath>gk-silemani-tv.stream'		,{ 'title': 'GK Silemani TV'}, icons + 'gk-silemani-tv.png')
    add_video_item('rtmp://live1.karwan.tv/rega-tv//rega-tv.stream'					,{ 'title': 'REGA TV'}, icons + 'rega-tv.png')
    add_video_item('rtmp://live1.karwan.tv/vin-tv//vin-tv.stream'						,{ 'title': 'Vin TV'}, icons + 'vin-tv.png')
    add_video_item('rtmp://live.karwan.tv:1935/jamawar-tv/<playpath>jamawar-tv.stream'				,{ 'title': 'Jamawar TV'}, icons + 'jamawar-tv.png')
    add_video_item('rtmp://live1.karwan.tv/karwan.tv//newroz-tv.stream'				,{ 'title': 'Newroz TV'}, icons + 'newroz-tv.png')
    add_video_item('rtmp://live2.karwan.tv/waar-tv//waar-tv.stream'					,{ 'title': 'WAAR TV'}, icons + 'waar-tv.png')
    add_video_item('rtmp://live.karwan.tv/waar-sport-tv//waar-sport-tv.stream'		,{ 'title': 'WAAR Sport TV'}, icons + 'waar-sport-tv.png')
